...
def MakeFigure(FigW,FigH, inp, out):
  ...
  left,bot,right,top = (0.20,0.3,0.90,0.95)
...
### Added by SMM ###
    if ires == 0:
      plt.axvline(x=-60.0, color='black', linewidth=1.25)
      plt.axhline(y=-30.0, color='black', linewidth=1.25)
    if ires == 1:
      plt.axvline(x=-90.0, color='black', linewidth=1.25)
      plt.axhline(y=0.0, color='black', linewidth=1.25)
    if ires == 3:
      plt.axvline(x=60.0, color='black', linewidth=1.25)
      plt.axhline(y=30.0, color='black', linewidth=1.25)
    if ires == 4:
