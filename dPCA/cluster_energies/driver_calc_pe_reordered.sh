...
#phipsi=s1cAAAAAA_reordered.xvg
group_dir=../../../s1/3_analysis/reordered_traj/prod02
trjcat_order=../../../s1/3_analysis/reordered_traj/prod02/order.txt
...
function calc_PE_reordered () {
   python $pydir/Py_reordered_energies.py Out_mapped_indexes.txt $ene1 $pop
   mv Out_aver* Out_clust* rerun/s1/complex
   python $pydir/Py_reordered_energies.py Out_mapped_indexes.txt $ene2 $pop
   mv Out_aver* Out_clust* rerun/s1/protein
   python $pydir/Py_reordered_energies.py Out_mapped_indexes.txt $ene3 $pop
   mv Out_aver* Out_clust* rerun/s1/solvent
}

calc_FE
calc_mapped_indexes
#calc_phipsi_reordered
calc_PE_reordered
